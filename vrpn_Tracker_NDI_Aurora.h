...
#ifndef VRPN_TRACKER_NDI_AURORA_H
#define VRPN_TRACKER_NDI_AURORA_H
...
class VRPN_API vrpn_Tracker_NDI_Aurora : public vrpn_Tracker {
...
public:
	...
	vrpn_Tracker_NDI_Aurora(const char *name,
		vrpn_Connection *c,
		const char *port,
		int numOfRigidBodies,
		const char** rigidBodyNDIRomFileNames);

	~vrpn_Tracker_NDI_Aurora();
